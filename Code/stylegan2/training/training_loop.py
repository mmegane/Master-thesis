...
def training_loop(
    ...
    misc.save_image_grid(grid_reals, dnnlib.make_run_dir_path('reals.png'), drange_in=training_set.dynamic_range, drange_out = [0,255], grid_size=grid_size)
    ...
    misc.save_image_grid(grid_fakes, dnnlib.make_run_dir_path('fakes_init.png'), drange_in=drange_net, drange_out = [0,255],grid_size=grid_size)
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        if cur_tick < 0 or cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            if image_snapshot_ticks is not None and (cur_tick % image_snapshot_ticks == 0 or done):
                grid_fakes = Gs.run(grid_latents, grid_labels, is_validation=True, minibatch_size=sched.minibatch_gpu)
                misc.save_image_grid(grid_fakes, dnnlib.make_run_dir_path('fakes%06d.png' % (cur_nimg // 1000)), drange_in=drange_net, drange_out = [0,255], grid_size=grid_size)
